...
ColorSquareEvent.prototype.init = function () {
  ...
  var sensitiveButton = document.getElementById(this.canvasID + "-sensitive-button");
  ...
  var render = function () {
    ...
    greenSliderNumber.textContent = greenValue;  // set text readout to new value
    blueSliderNumber.textContent = blueValue;  // set text readout to new value
  ...
  sensitiveButton.addEventListener("click",
          function () {
            alert("Don't Press Me! I'm Sensitive :(");   
          });
